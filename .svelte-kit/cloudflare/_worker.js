...
var is_array, index_of, includes, array_from, define_property, get_descriptor, object_prototype, array_prototype, get_prototype_of, is_extensible, has_own_property, noop, ATTR_REGEX, CONTENT_REGEX, replacements, whitespace;
...
var DERIVED, EFFECT, RENDER_EFFECT, MANAGED_EFFECT, BLOCK_EFFECT, BRANCH_EFFECT, ROOT_EFFECT, BOUNDARY_EFFECT, CONNECTED, CLEAN, DIRTY, MAYBE_DIRTY, INERT, DESTROYED, REACTION_RAN, EFFECT_TRANSPARENT, EAGER_EFFECT, HEAD_EFFECT, EFFECT_PRESERVED, USER_EFFECT, WAS_MARKED, REACTION_IS_UPDATING, ASYNC, ERROR_VALUE, STATE_SYMBOL, LEGACY_PROPS, STALE_REACTION, COMMENT_NODE, HYDRATION_START, HYDRATION_START_ELSE, HYDRATION_START_FAILED, HYDRATION_END, HYDRATION_ERROR, ELEMENT_IS_NAMESPACED, ELEMENT_PRESERVE_ATTRIBUTE_CASE, ELEMENT_IS_INPUT, UNINITIALIZED, tracing_mode_flag, component_context, micro_tasks, STATUS_MASK, batches, current_batch, batch_values, queued_root_effects, last_scheduled_effect, is_flushing_sync, collected_effects, uid, Batch, eager_block_effects, eager_effects, old_values, eager_effects_deferred, $window, first_child_getter, next_sibling_getter, is_updating_effect, is_destroying_effect, active_reaction, untracking, active_effect, current_sources, new_deps, skipped_deps, untracked_writes, write_version, read_version, update_version, DOM_BOOLEAN_ATTRIBUTES, PASSIVE_EVENTS, BLOCK_OPEN, BLOCK_CLOSE, EMPTY_COMMENT, controller, ssr_context, als2, text_encoder3, crypto2, obfuscated_import, Renderer, SSRState, INVALID_ATTR_NAME_CHAR_REGEX;
...
var SOCIAL_LINKS, SITE_CONFIG;
var init_index2 = __esm({
  ".svelte-kit/output/server/chunks/index2.js"() {
    SOCIAL_LINKS = {
      twitter: "https://x.com/madiou",
      discord: "https://discord.com/invite/jh2H577Ytr"
    };
    SITE_CONFIG = {
      tagline: "Where proven business models get cloned. A marketplace for founders who ship fast.",
      author: "Madiou",
      authorUrl: "https://x.com/madiou"
    };
  }
});
...
function Nav($$renderer) {
  $$renderer.push(`<nav class="nav svelte-1h32yp1"><div class="nav-container svelte-1h32yp1"><a href="/" class="logo svelte-1h32yp1">CloneSaaS</a> <a href="/#startups" class="nav-link svelte-1h32yp1">Browse Startups</a></div></nav>`);
}
function Footer($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    $$renderer2.push(`<footer class="footer svelte-jz8lnl"><div class="footer-container svelte-jz8lnl"><div class="footer-main svelte-jz8lnl"><div class="brand-section svelte-jz8lnl"><a href="/" class="footer-logo svelte-jz8lnl">CloneSaaS</a> <p class="footer-tagline svelte-jz8lnl">${escape_html2(SITE_CONFIG.tagline)}</p> <div class="social-links svelte-jz8lnl"><a${attr("href", SOCIAL_LINKS.twitter)} target="_blank" rel="noopener noreferrer" class="social-icon svelte-jz8lnl" aria-label="Twitter/X"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"></path></svg></a> <a${attr("href", SOCIAL_LINKS.discord)} target="_blank" rel="noopener noreferrer" class="social-icon svelte-jz8lnl" aria-label="Discord"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028 14.09 14.09 0 0 0 1.226-1.994.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z"></path></svg></a></div></div> <div class="links-section svelte-jz8lnl"><div class="link-column svelte-jz8lnl"><h4 class="column-title svelte-jz8lnl">Explore</h4> <nav class="column-links svelte-jz8lnl"><a href="/#startups" class="svelte-jz8lnl">Startups</a></nav></div> <div class="link-column svelte-jz8lnl"><h4 class="column-title svelte-jz8lnl">Connect</h4> <nav class="column-links svelte-jz8lnl"><a href="/about" class="svelte-jz8lnl">About</a> <a${attr("href", SOCIAL_LINKS.twitter)} target="_blank" rel="noopener noreferrer" class="svelte-jz8lnl">Contact</a></nav></div> <div class="link-column svelte-jz8lnl"><h4 class="column-title svelte-jz8lnl">Legal</h4> <nav class="column-links svelte-jz8lnl"><a href="/privacy" class="svelte-jz8lnl">Privacy</a> <a href="/terms" class="svelte-jz8lnl">Terms</a> <a href="/refund" class="svelte-jz8lnl">Refund Policy</a></nav></div></div></div> <div class="footer-bottom svelte-jz8lnl"><span class="copyright svelte-jz8lnl">\xA9 2026 CloneSaaS. All rights reserved.</span> <span class="credit svelte-jz8lnl">Built with care by <a${attr("href", SITE_CONFIG.authorUrl)} target="_blank" rel="noopener noreferrer" class="svelte-jz8lnl">${escape_html2(SITE_CONFIG.author)}</a></span></div></div></footer>`);
  });
}
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    imports2 = ["_app/immutable/nodes/1.CWUFWjTY.js", "_app/immutable/chunks/Ce244kTt.js", "_app/immutable/chunks/cd50jPoX.js", "_app/immutable/chunks/Cd5S5UHh.js", "_app/immutable/chunks/wHjTfLwW.js", "_app/immutable/chunks/CinzyV4g.js", "_app/immutable/chunks/B-TRy3kG.js", "_app/immutable/chunks/to1KES5G.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
...
function getStartupById(id) {
  return startups.find((s3) => s3.id === id);
}
function Hero($$renderer) {
  $$renderer.push(`<section class="hero svelte-1q37ri0"><div class="hero-bg svelte-1q37ri0"></div> <div class="hero-container svelte-1q37ri0"><div class="eyebrow svelte-1q37ri0">Skip the guesswork. Buy what works.</div> <h1 class="headline svelte-1q37ri0">Why Build From Scratch<br/> When You Can <span class="highlight svelte-1q37ri0">Clone Success</span></h1> <p class="subheadline svelte-1q37ri0">We took ${escape_html2(TOTAL_STARTUPS)} startups making real money, broke down exactly why they work, 
      and built ${escape_html2(TOTAL_CLONES)} niche spin-offs you can buy, rebrand, and launch as your own. 
      No validation needed. No wasted months. Just ship.</p> <div class="cta-wrapper svelte-1q37ri0"><button class="cta-button svelte-1q37ri0">Browse the Clones <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"></path></svg></button> <span class="cta-subtext svelte-1q37ri0">One payment. Full ownership. Launch this weekend.</span></div> <div class="stats-row svelte-1q37ri0"><div class="stat svelte-1q37ri0"><span class="stat-value svelte-1q37ri0">${escape_html2(TOTAL_STARTUPS)}</span> <span class="stat-label svelte-1q37ri0">Startups Cloned</span></div> <div class="stat-divider svelte-1q37ri0"></div> <div class="stat svelte-1q37ri0"><span class="stat-value svelte-1q37ri0">${escape_html2(TOTAL_CLONES)}</span> <span class="stat-label svelte-1q37ri0">Ready to Buy</span></div> <div class="stat-divider svelte-1q37ri0"></div> <div class="stat svelte-1q37ri0"><span class="stat-value text-accent svelte-1q37ri0">$${escape_html2(CLONE_PRICE)}</span> <span class="stat-label svelte-1q37ri0">Per Clone</span></div></div></div></section>`);
}
function HowItWorks($$renderer) {
  ...
  for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
    ...
    $$renderer.push(`<div class="step-card svelte-1e6pjgp"><div class="step-header svelte-1e6pjgp"><span class="step-number svelte-1e6pjgp">${escape_html2(step.number)}</span> <div class="step-line svelte-1e6pjgp"></div></div> <h3 class="step-title svelte-1e6pjgp">${escape_html2(step.title)}</h3> <p class="step-description svelte-1e6pjgp">${escape_html2(step.description)}</p></div>`);
  }
...
function CloneCard($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let { clone } = $$props;
    $$renderer2.push(`<div class="clone-card svelte-1amu1qz"><div class="card-content svelte-1amu1qz"><div class="card-header svelte-1amu1qz"><h3 class="clone-name svelte-1amu1qz">${escape_html2(clone.name)}</h3> <span class="audience-badge svelte-1amu1qz">${escape_html2(clone.audience)}</span></div> <p class="clone-niche svelte-1amu1qz">${escape_html2(clone.niche)}</p> <p class="clone-description svelte-1amu1qz">${escape_html2(clone.description)}</p></div> <div class="card-footer svelte-1amu1qz"><div class="price-container svelte-1amu1qz"><span class="price-label svelte-1amu1qz">One-time</span> <span class="price svelte-1amu1qz">$${escape_html2(clone.price)}</span></div> <button class="buy-button svelte-1amu1qz">Buy Clone <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M12 5l7 7-7 7"></path></svg></button></div></div>`);
  });
}
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    var $$store_subs;
    let startupId = derived(() => store_get($$store_subs ??= {}, "$page", page2).url.searchParams.get("startup"));
    let selectedStartup = derived(() => startupId() ? getStartupById(startupId()) : void 0);
    head("1uha8ag", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>${escape_html2(selectedStartup() ? `${selectedStartup().name} Clones - CloneSaaS` : "CloneSaaS - Buy a Proven Business Model")}</title>`);
      });
    });
    if (selectedStartup()) {
      $$renderer2.push("<!--[0-->");
...
var CLONE_PRICE, TOTAL_STARTUPS, TOTAL_CLONES, startups, getStores, page2;
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    stylesheets3 = ["_app/immutable/assets/PurchaseModal._l6n4i7s.css"];
    fonts3 = [];
  }
});
...
var options = {
  ...
  templates: {
    app: ({ head: head2, body: body2, assets: assets2, nonce, env }) => '<!doctype html>\r\n<html lang="en">\r\n  <head>\r\n    <meta charset="utf-8" />\r\n    <link rel="icon" href="' + assets2 + '/favicon.png" />\r\n    <meta name="viewport" content="width=device-width, initial-scale=1" />\r\n    <meta name="description" content="CloneSaaS - Buy proven business models. Launch in your niche." />\r\n    <link rel="preconnect" href="https://fonts.googleapis.com">\r\n    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>\r\n    <link href="https://fonts.googleapis.com/css2?family=Fredoka:wght@600;700&family=Nunito:wght@400;500;600;700&display=swap" rel="stylesheet">\r\n    ' + head2 + '\r\n    <title>CloneSaaS - Buy a Proven Business Model</title>\r\n  </head>\r\n  <body data-sveltekit-preload-data="hover">\r\n    <div style="display: contents">' + body2 + "</div>\r\n  </body>\r\n</html>\r\n",
...
var manifest = (() => {
  ...
  return {
    appDir: "_app",
    appPath: "_app",
    assets: /* @__PURE__ */ new Set(["clonesaas.png", "favicon.png", "faviconS/android-chrome-192x192.png", "faviconS/android-chrome-512x512.png", "faviconS/apple-touch-icon.png", "faviconS/favicon-16x16.png", "faviconS/favicon-32x32.png", "faviconS/favicon.ico", "faviconS/site.webmanifest"]),
    ...
    _: {
      ...
      prerendered_routes: /* @__PURE__ */ new Set(["/about", "/privacy", "/refund", "/terms"]),
      matchers: async () => {
        return {};
      },
      server_assets: {}
...
var prerendered = /* @__PURE__ */ new Set(["/about", "/privacy", "/refund", "/terms"]);
var base_path = "";
